...
const Partner = () => {
    return (
        <div className=' px-4 md:px-12 lg:px-28 py-8 md:py-12 lg:py-20 bg-base-100'>
            <div>
                <h1 className='text-center text-2xl lg:text-4xl font-semibold text-neutral'>Meet Our Partners</h1>
            ...
            <div className='grid md:grid-cols-2 gap-10 mt-8'>
                <div className='space-y-3'>
                    <div>
                        ...
                        <div>
                            <h1 className=' text-2xl font-semibold text-neutral'>DevPro Solutions</h1>
                    ...
                    <div>
                        ...
                        <div>
                            <h1 className='text-2xl  font-semibold text-neutral'>Fashionista Apparel</h1>
                ...
                <div className='space-y-3'>
                    <div>
                        ...
                        <div>
                            <h1 className='text-2xl font-semibold text-neutral'text-neutral>Beauty Bliss Co.</h1>
                    ...
                    <div>
                        ...
                        <div>
                            <h1 className=' text-2xl font-semibold text-neutral'>Golden Hops Brewery</h1>
