    ...
    return (
        <div className='grid lg:grid-cols-2 gap-5 px-4 md:px-12 lg:px-28 py-8 md:py-12 lg:py-20'>
            <div className='flex flex-col gap-4 items-start justify-center max-w-xl'>
                <h1 className='text-2xl lg:text-4xl font-semibold '>Rate us, Review us, and Help Others Find the Best Services</h1>
                ...
                <Link to={`/services`}><motion.button whileTap={{ scale: 0.9 }} className="py-2 text-white font-medium px-6 rounded-sm bg-customGreen flex items-center gap-2">Review Now <FaArrowRightLong /></motion.button></Link>
            </div>
            <div>
                <img src={img} alt="" />
            </div>
